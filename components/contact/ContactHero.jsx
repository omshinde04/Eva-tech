    ...
    return (
      ...
      "
        >
          ...
          justify-center
          gap-8 sm:gap-10 md:gap-12   /* 🔥 INCREASED SPACING */
        "
            >
                ...
                <motion.div
                    ...
                    className="px-5 py-2 rounded-full bg-white/80 backdrop-blur 
          text-sm text-textSecondary shadow-sm border border-borderSubtle"
                >
                ...
                <motion.h1
                    ...
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-semibold text-textPrimary leading-[1.1] tracking-tight"
                >
            ...
            transition-all duration-300 hover:scale-[1.05]"
                ...
                <motion.div
                    ...
                    className="text-sm text-textMuted mt-2"
                >
